...
export const AutoGenComponent =({path,field, fieldToUse,size}:AutoGenComponentProps) =>{
    const { value, setValue } = useField<string>({
      ...
      const handleGenerate = useCallback(
        ...
        [setValue, value, fieldToUse, size, getDataByPath]
      );
      ...
      >
        ...
        <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
          ...
          <TextInput
            ...
            value={value || ""}
            onChange={setValue}
            style={{ flex: 1 }} // chiếm full width còn lại
          />
        </div>
      </div>
