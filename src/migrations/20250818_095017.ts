...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_payload_folders_folder_type" AS ENUM('media', 'products');
  ...
  CREATE TABLE "category" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"is_most_parent" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "products" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"category_id" integer,
  	"price_base_price" numeric,
  	"price_discount" numeric DEFAULT 0,
  	"price_final_price" numeric,
  	"image_id" integer,
  	"content" jsonb,
  	"folder_id" integer,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_products_v" (
  	...
  	"version_price_base_price" numeric,
  	"version_price_discount" numeric DEFAULT 0,
  	"version_price_final_price" numeric,
  ...
  ALTER TABLE "category_breadcrumbs" ADD CONSTRAINT "category_breadcrumbs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."category"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "category_locales" ADD CONSTRAINT "category_locales_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "category_rels" ADD CONSTRAINT "category_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."category"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "category_rels" ADD CONSTRAINT "category_rels_category_fk" FOREIGN KEY ("category_id") REFERENCES "public"."category"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "products_gallery" ADD CONSTRAINT "products_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_gallery" ADD CONSTRAINT "products_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "products" ADD CONSTRAINT "products_category_id_category_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."category"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_products_v" ADD CONSTRAINT "_products_v_version_category_id_category_id_fk" FOREIGN KEY ("version_category_id") REFERENCES "public"."category"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "search_rels" ADD CONSTRAINT "search_rels_category_fk" FOREIGN KEY ("category_id") REFERENCES "public"."category"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "category_breadcrumbs_order_idx" ON "category_breadcrumbs" USING btree ("_order");
  CREATE INDEX "category_breadcrumbs_parent_id_idx" ON "category_breadcrumbs" USING btree ("_parent_id");
  ...
  CREATE UNIQUE INDEX "category_slug_idx" ON "category_locales" USING btree ("slug","_locale");
  CREATE INDEX "category_meta_meta_image_idx" ON "category_locales" USING btree ("meta_image_id","_locale");
  CREATE UNIQUE INDEX "category_locales_locale_parent_id_unique" ON "category_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "category_rels_order_idx" ON "category_rels" USING btree ("order");
  CREATE INDEX "category_rels_parent_idx" ON "category_rels" USING btree ("parent_id");
  CREATE INDEX "category_rels_path_idx" ON "category_rels" USING btree ("path");
  CREATE INDEX "category_rels_category_id_idx" ON "category_rels" USING btree ("category_id");
  ...
  CREATE INDEX "search_rels_category_id_idx" ON "search_rels" USING btree ("category_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "category_breadcrumbs" CASCADE;
  DROP TABLE "category" CASCADE;
  DROP TABLE "category_locales" CASCADE;
  DROP TABLE "category_rels" CASCADE;
